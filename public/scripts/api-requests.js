/**
 * Makes a call to all available APIs
 * API calls are rejected if they don't resolve before the timeout
 * @param  {string} query Search query sent to APIs
 * @return {Promise<{}>}  Returns a promise to the APIs including the result and desired data from each API
 */
...
/**
 * Makes an API request to the OMDB API
...
/**
 * Makes an API request to the TMDB API
 * @param  {string}      query URI encoded search query sent to API
 * @return {Promise<{}>}       Object with data from the API
 */
...
/**
 * Makes an API request to the Google Books API
 * @param  {string}      query URI encoded search query sent to API
 * @return {Promise<{}>}       Object with data from the API
 */
...
/**
 * Makes an API request to the IP API to get user location
 * Makes an API request to the Yelp API using location from IP API
 * @param  {string}      query URI encoded search query sent to API
 * @return {Promise<{}>}       Object with data from the API
 */
...
/**
 * Makes an API request to the Amazon Price API
